...
if sum(Z2) > 1 && ~params.oneobj,
    ...
    fmaxv = 100; % [mm] WHY IS THIS HARD-CODED? EH100426
    
    % MIN/MAX ALLOWED DISPLACEMENT
    ...
    % IF MOVIE CONTAINS ONLY ONE FLY
    ...
    if params.border,
        ...
        if params.radius > 0,
            r1 = sqrt((fly_feat.obj1.pos_x).^2 + ...
                (fly_feat.obj1.pos_y).^2);
            % The positions were already centered in analyze_data (line 200) prior to fly_feat being
            % passed to den_feat. EDH100510
