...
function chase = chasing(fly_feat,b_len,maxg,chase)
...
maxg = round(maxg/dt);
ind1 = zeros(1,NFrms); ind1(fly_feat.obj1.chase > 0) = 1;
ind2 = zeros(1,NFrms); ind2(fly_feat.obj2.chase > 0) = 1;
% DETECT BOUTS OF ACTION AND SETUP DATA STRUCTURE
[chase,i1,i2] = detect_bouts(fly_feat,ind1,ind2,b_len,maxg,chase,5);
