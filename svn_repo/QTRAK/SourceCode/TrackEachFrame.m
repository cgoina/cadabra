%% TrackEachFrame
% Copyright (C) 2009 Janelia Farm Research Campus
...
function TrackEachFrame( data, images, width, height, frameNr, time )
global ic dt params CurrentK;
global Files FigureHandle Panels;

%     params.QuitPrg = 0; params.bool_plotcount = 0;
    if params.QuitPrg, error('STOP PROCESSING'); end
    ...
    try
        ...
        PlotEachFrame( data, images, width, height, FigureHandle, frameNr );            
