 ...
 */
FARPROC WINAPI qtrakDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = qtrakDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = qtrakDelayLoadWin32FailureHook;
#endif
