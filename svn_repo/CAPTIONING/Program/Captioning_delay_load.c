 ...
 */
FARPROC WINAPI CaptioningDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = CaptioningDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = CaptioningDelayLoadWin32FailureHook;
#endif
