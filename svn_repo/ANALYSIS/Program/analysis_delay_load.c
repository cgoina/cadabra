 ...
 */
FARPROC WINAPI analysisDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = analysisDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = analysisDelayLoadWin32FailureHook;
#endif
