...
function msg = GNU_message_analysis(short_msg)
...
if ~short_msg,
    msg = cell(19,1);
    msg{1} = 'CADABRA v1.02 (ANALYSIS v1.02)';
    
    msg{3} = 'Copyright (c) 2008 Heiko Dankert, California Institute of Technology';

    msg{5} = 'This program is part of ANALYSIS and the "Caltech Automated Drosophila';
    ...
    msg = cell(4,1);
    msg{1} = 'Copyright © 2008 Heiko Dankert, California Institute of Technology';
